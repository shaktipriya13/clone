    ...
    <div>
      ...
      <div className="home-content">
        ...
        <div style={{ display: 'flex', gap: '10px', margin: '10px', flexWrap: 'wrap' }}>
            ...
            <FeaturedGrid title="Best Deals on Furniture" sectionTag="furniture_bestsellers" />
            <FeaturedGrid title="Make your home stylish" sectionTag="home_stylish" />
        </div>
        ...
        <div style={{ display: 'flex', gap: '10px', margin: '10px', flexWrap: 'wrap' }}>
             <FeaturedGrid title="Best Value Deals on Fashion" sectionTag="fashion_value" />
